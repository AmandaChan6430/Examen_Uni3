...
def agregar():
    ...
    try:
        ...
        miCursor.execute("INSERT INTO admins (id,nombre,contraseña,cargo) VALUES(?,?,?,?)",
                         (num, miNombremin, miContramin, miCargomin))
        conexion.commit()
    except:
        messagebox.showwarning("ADVERTENCIA",
                               "Ocurrió un error al crear el registro, verifique su conexion con la base de datos")
        pass
...
def eliminar():
    def eliminar2():
        ...
        if variable == False:
            ...
            tk.Label(ventanacomp5,
                     text=""" si esta seguro de querer eliminar sus datos presione "Borrar", si no, presione "Cerrar" """,
                     bg="beige",
...
def comprobacion():
    def update():
        ...
        if variable == False:
            ...
            tk.Label(ventanaup, bg="beige",
                     text=" ID = " + filabonitax5 + ", NOMBRE = " + filabonita5 + ", CONTRASEÑA = " + filabonitaxx5 + ",  PUESTO = " + filabonitaxxx5).pack()
